...
png(paste0(plot_dir,"technical_covariates_design_matrix.png"))
image(X)
dev.off()
...
#ggsave(paste0(plot_dir,"technical_covariates_pp.png"), scale=1)
...
ggsave(paste0(plot_dir,"technical_covariates_individual_season.png",sep=""), scale=1.5)
