# this file answers a variety of high-level questions like "does 'baseline' distance correlation with 
# dynamics distance?" and "what proportion of [unfiltered] taxa are present across hosts?"
#
...
for(level in levels) {
  ...
  ggsave(file.path(relative_path,plot_dir,paste0("posterior_dist_vs_dist_",level,".png")), plot=p, scale=1.5, width=5, height=5, units="in", dpi=100)
}
