# this file has some very very old and preliminary exploratory plots
...
ggsave(file.path(plot_dir,"ABRP_overview.png"), scale=1.5, width=12, height=6, units="in")
...
# ====================================================================================================================
# covariance matricies ordered on covariates
# ====================================================================================================================
...
ggsave(file.path(plot_dir,"season_ordination_100.png"), plot=p, width=6, height=5, units="in", scale=1.5)
...
ggsave(file.path(plot_dir,"grp_ordination_100.png"), plot=p, width=6, height=5, units="in", scale=1.5)

# label SEX
cat("Plotting sex-wise labeling on ordination...\n")
p <- plot_ordination(baboon_counts, ord, type="sample", color="sex")
ggsave(file.path(plot_dir,"sex_ordination_100.png"), plot=p, width=6, height=5, units="in", scale=1.5)
...
ggsave(file.path(plot_dir,"matgrp_ordination_100.png"), plot=p, width=6, height=5, units="in", scale=1.5)
...
ggsave(file.path(plot_dir,"age_ordination_100.png"), plot=p, width=6, height=5, units="in", scale=1.5)
...
ggsave(file.path(plot_dir,"sname_ordination_100.png"), plot=p, width=6, height=5, units="in", scale=1.5)
}
